...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1100000000000);
...
const char     CRYPTONOTE_NAME[]                             = "aether";
...
const int      P2P_DEFAULT_PORT                              =  28291;
const int      RPC_DEFAULT_PORT                              =  28292;
...
const char* const SEED_NODES[] = { "88.99.86.245:28291", "88.99.123.159:28291" };
